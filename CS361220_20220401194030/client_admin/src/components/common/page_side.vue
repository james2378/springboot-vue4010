<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/candidate_user/table" v-show="user_group == '管理员' || $check_action('/candidate_user/table')"><span>考生用户</span></el-menu-item>
